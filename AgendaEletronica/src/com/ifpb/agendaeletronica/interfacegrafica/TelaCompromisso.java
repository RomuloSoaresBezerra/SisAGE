    ...
    private void botaoOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoOkActionPerformed
        ...
        try {
           ...
           compromisso.setHora(hora);
            ...
            try {
                Agenda u = dao.readAgenda((String) comboAgenda.getSelectedItem());
                if (u.getEmail().equals(TelaInicial.usuarioLogado.getEmail())){
                   u.createCompromisso(compromisso);
                   dao.updateAgenda(u);
  
                    
                    System.out.println(dao.readAgenda((String) comboAgenda.getSelectedItem()));
                    JOptionPane.showMessageDialog(null,
                            "Compromisso adicionado com sucesso");
                    this.dispose();
                } else {
                    JOptionPane.showMessageDialog(null,
                            "Compromisso não pôde ser adicionado",
                            "Mensagem de erro",
